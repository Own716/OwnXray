                            ...
                            MaterialAboutActionItem.Builder()
                                ...
                                .setOnClickAction {
                                    requireContext().launchCustomTab(
                                        "https://github.com/Own716/OwnXray/releases"
                                    )
                                }
                                .build())
                        .addItem(
                    ...
                    MaterialAboutCard.Builder()
                        ...
                        .addItem(
                            MaterialAboutActionItem.Builder()
                                ...
                                .setOnClickAction {
                                    requireContext().launchCustomTab(
                                        "https://github.com/Own716/OwnXray"
                                    )
                                }
                                .build())
                        .addItem(
            ...
            runOnIoDispatcher {
                try {
                    ...
                    val url = if (isPreview) {
                        "https://api.github.com/repos/Own716/OwnXray/releases"
                    } else {
                        "https://api.github.com/repos/Own716/OwnXray/releases/latest"
                    }
